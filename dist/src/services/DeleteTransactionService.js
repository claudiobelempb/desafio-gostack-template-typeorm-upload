            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, transactionRepository.findOne(id)];
                    case 1:
                        transaction = _b.sent();
                        if (!transaction) {
                            throw new AppError_1.default('Transation not found');
                        }
                        return [4 /*yield*/, transactionRepository.remove(transaction)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                }
