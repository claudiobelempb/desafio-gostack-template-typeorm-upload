...
var CreateTransactionService = /** @class */ (function () {
    ...
    CreateTransactionService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var categoryRepository, transactionRepository, balance, categoryExists, transaction;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (type !== 'income' && type !== 'outcome') {
                            throw new AppError_1.default('Type não permitido.');
                        }
                    ...
                    case 1:
                        ...
                        if (type === 'outcome' && balance.total < value) {
                            throw new AppError_1.default('Saldo insuficiente.');
                        }
                    ...
                    case 3:
                        categoryExists = _b.sent();
                        return [4 /*yield*/, categoryRepository.save(categoryExists)];
                    case 4:
                        _b.sent();
                        _b.label = 5;
                    case 5: return [4 /*yield*/, transactionRepository.create({
                            title: title,
                            type: type,
                            value: value,
